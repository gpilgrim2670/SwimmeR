...
The second issue is that `Texas` and `Florida` are styled as `Texas, University of` and `Florida, University of` which may cause `swim_parse` to interpret them as `Lastname, Firstname`.
