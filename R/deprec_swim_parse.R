...
#'
#' Takes the output of \code{read_results} and cleans it, yielding a data frame of swimming (and diving) results.  Old version, retired in dev build on Dec 21, 2020 and release version 0.7.0
#'
