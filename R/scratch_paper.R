...
text <- read_results("http://easternzoneswimming.org/meet_results/2019SpringSectionals_LongCourse_Results_Women.html")
df <- swim_parse(text, typo = "Clifton Park-Hal-AD", replacement = "Clifton Park-Hal-AD  ")
